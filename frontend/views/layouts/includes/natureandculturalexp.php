...
<div class="nature-clutural-sec">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="main_title">
                  <h2>Nature and Cultural Expreience</h2>
              ...
              <?php foreach($packages as $pData){?>
                  <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                    <?=$this->render("//package/include/single-package-layout-4",['model'=>$pData]);?>
                    </div><!-- End col -->
              <?php }?>
  ...
  </div><!-- End of nature-clutural-sec -->
